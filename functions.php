...
function fecha($fecha){
	$timestamp = strtotime($fecha); //Nos convierte de una cadena de texto a tiempo
	...
	// $test = date('A', $timestamp);

	// $fecha = $dia . ' de ' . $meses[$mes] . ' del ' . $year . ' hora: ' . $hora . ':' . $minutos . ' ' . $test ;
	// return $fecha; //Funciona, para mostrar la hora
