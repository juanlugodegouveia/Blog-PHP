	...
	<div class="contenedor">
		<div class="post">
			<article>
				...
				<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" enctype="multipart/form-data" class="formulario" method="post"><!-- enctype="multipart/form-data" para poder agregar archivos sin errores -->
